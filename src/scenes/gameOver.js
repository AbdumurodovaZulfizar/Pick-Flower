...
import gameOverMusic from '../assets/sounds/over.wav';
...
class GameOver extends Phaser.Scene {
  ...
  addScore() {
    this.add.text(gameState.canvas.width * scoreRate(), gameState.canvas.height * 0.3, `${gameState.score}`, { fill: '#FFFFFF', font: '800 68px Roboto' });
  }
